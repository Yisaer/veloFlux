...
mod tests {
    ...
    #[test]
    fn test_shared_stream_ingest_sampler_appears_before_decoder() {
        use crate::catalog::StreamDecoderConfig;
        use crate::planner::shared_stream_plan::create_physical_plan_for_shared_stream;
        ...
        assert!(
            decoder_row.id.contains("PhysicalDecoder_2"),
            "decoder should be allocated after datasource and sampler: {}",
            report.table_string()
        );
        assert!(
